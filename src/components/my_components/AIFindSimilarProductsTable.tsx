...
import {defaultLlmModel} from "src/config";
...
export default function AIFindSimilarProductsTable({
    ...
    useEffect(() => {
        ...
        jwtFetch(null, `entities/${entity.id}/ai_find_similar_products/?llm_model=${defaultLlmModel}`).then((data) => {
        ...
        <Card>
            ...
            <CardContent>
                    ...
                    <CustomTable
                        ...
                        rows={aiFindSimilarProducts.map(entry => [
                            ...
                            <Button
                                variant="contained"
                                onClick={() => {
                                    handleTableProductAssociationSubmit(entry["product"]["id"])
                                }}
                            >
                                Asociar
                            </Button>
                ...
                <Button
                    ...
                    variant="contained"
                    onClick={() => {
                        handleAIFindSimilarProductsSubmit()
                    }}
                >
